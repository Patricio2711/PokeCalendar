...
* `android_app` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `android_app` - executable or bundle name on disk.
* `android_app` - display name shown in window titles and about app dialogs.
